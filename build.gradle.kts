...
dependencies {
    ...
    implementation("org.jetbrains.kotlin-wrappers:kotlin-react:18.2.0-pre.524-compat")
    implementation("org.jetbrains.kotlin-wrappers:kotlin-react-dom:18.2.0-pre.524-compat")
